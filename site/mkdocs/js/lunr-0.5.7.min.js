...
! function () {
    ...
    t.version = "0.5.7", t.utils = {}, t.utils.warn = function (t) {
            return function (e) {
            ...
            for (var e = t.toString().replace(/^\s+/, ""), n = e.length - 1; n >= 0; n--)
                if (/\S/.test(e.charAt(n))) {
                    e = e.substring(0, n + 1);
                    break
                } return e.split(/(?:\s+|\-)/).filter(function (t) {
                return !!t
            }).map(function (t) {
                return t.toLowerCase()
            })
            ...
            n.forEach(function (e, n, s) {
                var a = 1 / s.length * this._fields.length * r,
                    ...
                    u = this.tokenStore.expand(e).reduce(function (n, o) {
                        ...
                        return r > -1 && i.insert(r, a * s * u), Object.keys(h.tokenStore.get(o)).forEach(function (t) {
                            l.add(t)
                        }), n.union(l)
                    }, new t.SortedSet);
                o.push(u)
            ...
            var t = {
                ...
                $ = function (n) {
                    ...
                    if (r = n.substr(0, 1), "y" == r && (n = r.toUpperCase() + n.substr(1)), s = d, a = v, s.test(n) ? n = n.replace(s, "$1$2") : a.test(n) && (n = n.replace(a, "$1$2")), s = m, a = g, s.test(n)) {
                        var $ = s.exec(n);
                        s = l, s.test($[1]) && (s = y, n = n.replace(s, ""))
                    } else if (a.test(n)) {
                        var $ = a.exec(n);
                        i = $[1], a = f, a.test(i) && (n = i, a = S, h = w, u = x, a.test(n) ? n += "e" : h.test(n) ? (s = y, n = n.replace(s, "")) : u.test(n) && (n += "e"))
                    }
                    if (s = k, s.test(n)) {
                        var $ = s.exec(n);
                        i = $[1], n = i + "i"
                    ...
                    if (s = F, s.test(n)) {
                        var $ = s.exec(n);
                        i = $[1], s = c, a = p, h = T, (s.test(i) || a.test(i) && !h.test(i)) && (n = i)
                    }
